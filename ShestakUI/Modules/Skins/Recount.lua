...
RecountDB["profiles"][T.name.." - "..T.realm]["MainWindow"]["Position"]["y"] = -392
RecountDB["profiles"][T.name.." - "..T.realm]["MainWindow"]["Position"]["w"] = 221
RecountDB["profiles"][T.name.." - "..T.realm]["MainWindow"]["Position"]["h"] = 128
RecountDB["profiles"][T.name.." - "..T.realm]["MainWindow"]["BarText"]["NumFormat"] = 3
--RecountDB["profiles"][T.name.." - "..T.realm]["MainWindowWidth"] = 0
--RecountDB["profiles"][T.name.." - "..T.realm]["MainWindowHeight"] = 0
